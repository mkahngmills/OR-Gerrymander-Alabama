...
It is an exploratory study to evaluate usefulness of a new gerrymandering metric based on the convex hull and representativness in the convex hull compared to the congressional district.
